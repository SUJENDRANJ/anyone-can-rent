    ...
    <div className="container max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        ...
        <div className="flex items-center justify-between">
          ...
          <Badge
            variant={
              kycStatus.overallStatus === "approved" ? "default" : "secondary"
            }
          >
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    JPG, PNG or GIF. Max size 2MB. Professional photos increase
                    bookings by 40%.
                  </p>
                </div>
              </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                />
                <p className="text-xs text-muted-foreground">
                  A good bio helps renters trust you. Mention your experience,
                  interests, and what makes you a great host.
                </p>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent>
              {kycStatus.overallStatus === "approved" ? (
                <Alert>
                  ...
                  <AlertDescription>
                    Your account is fully verified! You can now host items on
                    our platform.
                  </AlertDescription>
                </Alert>
              ) : (
                <Alert>
                  ...
                  <AlertDescription>
                    Complete your verification to start hosting items and build
                    trust with renters.
                  </AlertDescription>
                </Alert>
              )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card>
              ...
              <CardContent>
                ...
                <div className="flex items-center justify-between">
                  <Badge
                    variant={kycStatus.phoneVerified ? "default" : "secondary"}
                  >
            ...
            <Card>
              ...
              <CardContent>
                ...
                <div className="flex items-center justify-between">
                  <Badge
                    variant={
                      kycStatus.identityVerified ? "default" : "secondary"
                    }
                  >
            ...
            <Card>
              ...
              <CardContent>
                ...
                <div className="flex items-center gap-2">
                  <Badge
                    variant={
                      kycStatus.addressVerified ? "default" : "secondary"
                    }
                  >
            ...
            <Card>
              ...
              <CardContent>
                ...
                <div className="flex items-center justify-between">
                  <Badge
                    variant={kycStatus.bankVerified ? "default" : "secondary"}
                  >
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Receive booking updates and messages
                    </p>
                  </div>
                  <Button variant="outline" size="sm">
                    Configure
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Get urgent notifications via text
                    </p>
                  </div>
                  <Button variant="outline" size="sm">
                    Configure
