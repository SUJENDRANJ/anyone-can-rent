...
const mockNotifications: Notification[] = [
  {
    ...
    message:
      "John Doe wants to rent your Wireless Headphones for 3 days starting Jan 20th.",
  ...
  },
  {
    ...
    message:
      "Your KYC verification has been approved. You can now start hosting items.",
  ...
  },
  {
    ...
    message:
      "Your rental of Professional Camera Lens starts tomorrow. Don't forget to pick it up!",
