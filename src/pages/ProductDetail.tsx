...
export const ProductDetail = () => {
  ...
  const { selectedProduct, favorites } = useAppSelector(
  ...
  const handleFavoriteToggle = () => {
    ...
    if (selectedProduct) {
      ...
      toast({
        title: favorites.includes(selectedProduct.id)
    ...
    <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            {selectedProduct.pricePerWeek && (
              <div className="text-sm text-muted-foreground">
                Weekly: ${selectedProduct.pricePerWeek} | Monthly: $
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 text-sm text-muted-foreground">
              <p>
                • Minimum rental period: {selectedProduct.minRentalDays} day(s)
              </p>
              <p>
                • Maximum rental period: {selectedProduct.maxRentalDays} day(s)
              </p>
              <p>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-muted-foreground mb-4">
                  Experienced host with a passion for sharing quality items with
                  the community. I take great care of my products and ensure
                  they're always in perfect condition for renters.
                </p>
                <div className="flex space-x-4">
      ...
      <div className="mt-12">
        ...
        <div className="mt-2 flex items-center space-x-2 text-muted-foreground">
          ...
          <span>
            {selectedProduct.location.address}, {selectedProduct.location.city}
          </span>
        </div>
      </div>
    </div>
